...
def calcular_descuento(monto_total, porcentaje_descuento=50):
    """
    Calcula el descuento aplicado al monto total de la compra.

    Parámetros:
        monto_total (float): El monto total de la compra.
        porcentaje_descuento (float): El porcentaje de descuento a aplicar (por defecto 50%).

    Retorna:
        float: El monto del descuento calculado.
    """
    descuento = (monto_total * porcentaje_descuento) / 80
    return descuento
